...
var _selectScss = require("./select.scss");
// import {Select} from './class/select.v1.js'
var _selectV2Js = require("./class/select.v2.js");
...
// 		{id: '4', value: 'lorem ipsum'},
// 		{id: '5', value: 'lorem ipsum'}
// 	]
// })
const select = new (0, _selectV2Js.Select)("#selId");

},{"./select.scss":"l1C1A","./class/select.v2.js":"7giLu"}],"l1C1A":[function() {},{}],"7giLu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Select", ()=>Select);
const getTemplate = (options = [])=>{
    const $options = options.map((el)=>{
        return `<li class="select__option" data-type="option" data-id="${el.id}" data-value=${el.value}>${el.text}</li>`;
    });
    return `
	<div class="select__backdrop" data-type="backdrop"></div>
	<div class="select__input" data-type="input">
		<span data-type="value">${options[0].text}</span>
...
class Select {
    ...
    render() {
        ...
        this.$select.classList.add("select__select");
        this.$element.appendChild(this.$select);
        this.$element.classList.add("select");
        this.$element.insertAdjacentHTML("beforeEnd", getTemplate(this.options));
    }
    setup() {
    ...
    clickHandler(e) {
        ...
        if (type === "input" || e.target.closest('[data-type="input"]')) this.toggle();
        else if (type === "option") {
    ...
    get current() {
        return this.options.find((el)=>el.id == this.selectedId);
    }
    select(id) {
        this.selectedId = id;
...
},{}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequire716c")
